...
const profiles = [
  { platform: 'GitHub', username: 'shamvelayutham541-sketch', icon: FaGithub, color: 'text-cyan-accent', link: 'https://github.com/shamvelayutham541-sketch' },
  { platform: 'LeetCode', username: 'sham_codes', icon: Code2, color: 'text-yellow-400', link: 'https://leetcode.com/u/sham_codes/' },
  { platform: 'HackerRank', username: 'sham_codes', icon: Terminal, color: 'text-green-400', link: 'https://www.hackerrank.com/profile/sham_codes' },
  { platform: 'CodeChef', username: 'sham_codes', icon: Code, color: 'text-orange-400', link: 'https://www.codechef.com/users/sham_codes' },
  { platform: 'Codeforces', username: 'sham_codes', icon: Cpu, color: 'text-blue-400', link: 'https://codeforces.com/profile/sham_codes' },
  { platform: 'GeeksforGeeks', username: 'sham_codes', icon: Database, color: 'text-green-500', link: 'https://www.geeksforgeeks.org/user/sham_codes/' },
];
